...
for p2 = 1: numAlleles 
    for p1 = 1: numAlleles 
        genoType = allelesToGenotypes(p1, p2);
        prob = alphaList(genoType);
        phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [1, p1, p2], prob);
        phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [2, p1, p2], 1 - prob);
    end
end
